...
export default function AdminPostsPage() {
  ...
  const fetchPosts = async () => {
    try {
      ...
      const response = await fetch(`${apiUrl}/api/posts/admin`, {  // ✅ FIXED
        headers: {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const url = editingPost
        ? `${apiUrl}/api/posts/admin/${editingPost.id}`  // ✅ FIXED
        : `${apiUrl}/api/posts/admin`;  // ✅ FIXED
  ...
  const handleDelete = async (postId: number) => {
    ...
    try {
      ...
      const response = await fetch(`${apiUrl}/api/posts/admin/${postId}`, {  // ✅ FIXED
        method: 'DELETE',
        headers: {
          'Authorization': `Bearer ${token}`,
        },
  ...
  const handleEdit = (post: Post) => {
    ...
    setFormData({
      username: post.username,  // ✅ ADDED
      user_email: post.user_email,  // ✅ ADDED
