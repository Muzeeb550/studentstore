...
=======
                          ...
                          <div style={{ padding: '0.75rem 0' }}>
                            ...
                            >
                              ...
                              <div style={{ textAlign: 'left' }}>
                                <p style={{ fontWeight: 600, fontSize: '0.9375rem' }}>Skill Store</p>
                                <p style={{ fontSize: '0.75rem', color: '#64748B' }}>Learn new skills</p>
                              </div>
                            </a>
...
=======
                        ...
                        <div className="py-2">
                          ...
                          {/* SkillStore Link - NEW */}
<button
  onClick={() => handleNavigation('/skillstore')}
  onTouchEnd={(e) => {
    e.preventDefault();
    e.stopPropagation();
    handleNavigation('/skillstore');
  }}
  className="navbar-dropdown-item"
>
  <svg className="w-5 h-5 text-student-secondary mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
