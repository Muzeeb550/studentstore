                      ...
                      <div key={review.id} className="bg-student-card rounded-2xl shadow-xl p-6 border border-border-light hover:shadow-2xl transition-all duration-300">
                        <div className="flex items-start space-x-4">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            {/* ✅ NEW: Review Footer with Vote Counts */}
                            <div className="flex flex-col space-y-2 pt-3 border-t border-border-light mt-3">
                              {/* Vote Display */}
                              {(review.helpful_count > 0 || review.not_helpful_count > 0) && (
                                <div className="flex items-center space-x-2">
                                  {review.helpful_count > 0 && (
                                    <div className="flex items-center space-x-1 text-xs bg-student-green/10 px-2 py-1 rounded-full">
                                      ...
                                      <span className="text-student-secondary">useful</span>
                                    </div>
                                  )}
                                  
                                  {review.not_helpful_count > 0 && (
                                    <div className="flex items-center space-x-1 text-xs bg-student-orange/10 px-2 py-1 rounded-full">
